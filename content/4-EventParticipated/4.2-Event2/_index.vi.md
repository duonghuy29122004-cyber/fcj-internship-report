...
- **Demo:** Hướng dẫn đầy đủ CI/CD pipeline
...
- **AWS CDK (Cloud Development Kit):** Constructs, reusable patterns và hỗ trợ ngôn ngữ
...
- **Demo:** Thiết lập observability toàn diện
...
- Hiểu biết đầy đủ về dịch vụ AWS DevOps và CI/CD pipelines
- Trải nghiệm thực hành với Infrastructure as Code (CloudFormation & CDK)
- Container orchestration với ECS và EKS
- Best practices về monitoring và observability
- Case studies thực tế và chiến lược triển khai DevOps
