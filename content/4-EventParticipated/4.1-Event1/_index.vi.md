...
- Đăng ký và giao lưu giữa các thành viên
...
- **Live Demo:** Hướng dẫn SageMaker Studio
...
- **Bedrock Agents:** Quy trình nhiều bước và tích hợp công cụ
- **Guardrails:** An toàn và lọc nội dung
- **Live Demo:** Xây dựng chatbot Generative AI sử dụng Bedrock

---

### Kiến thức Thu được

- Trải nghiệm thực hành với các dịch vụ AWS AI/ML
- Hiểu biết về khả năng Generative AI với Amazon Bedrock
- Kiến thức thực tế về kiến trúc RAG và triển khai
- Giao lưu với các chuyên gia AI/ML tại Việt Nam
